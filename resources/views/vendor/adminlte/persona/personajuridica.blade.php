	...
	<div class="container-fluid spark-screen">
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
        		<h3 class="text-center color-azul"><strong><i class="fa fa-list" aria-hidden="true"></i>&nbsp; Listado de Personas Juridicas&nbsp;<i class="fa fa-list" aria-hidden="true"></i></strong></h3>  
